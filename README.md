...
Class project for Coursera class Gettnig and Cleaning Data
...
Column headings for the Mean_by_Activity_Subject.txt file were taken from the features.txt file with the following changes:

- Double parenthesis "()" were removed
